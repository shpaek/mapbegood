<template>
    <div class="menubar">
        <ul>
            ...
            <!-- 로그인 관계없이 보여줄 거 -->
            <img src="../../public/images/logo.jpg" alt="로고" @click="logoClickHandler" />
            <router-link to="/nickchange" class="menubar">{{ nickname }}</router-link>

            <!-- 로그인 관계없이 보여줄 거 -->
            <li><router-link to="/" class="menubar">추천<br>테마지도</router-link></li>

            <!-- 로그인된 경우 -->
            <!-- <template v-show="loginedId != ''"> -->
            <li><router-link to="/thememaplist" class="menubar">내 테마지도</router-link></li>
            <li><router-link to="/favoritelist" class="menubar">즐겨찾기</router-link></li>
