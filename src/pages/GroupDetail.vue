  ...
  <div class="g-part">
    ...
    <div class="group-thememap-list">
      <div class="new-thememap cursor-pointer btn btn-outline-dark" @click="addnewgroupclickHandler">
        <!-- 그룹 테마지도 추가버튼 -->
        <div class="new-thememap cursor-pointer btn btn-outline-dark" @click="openCreateGroupMapModal">
        <span class="new">
...
export default {
  name: "GroupDetail",
  methods: {
    openCreateGroupMapModal() {
      this.$store.commit('openCreateGroupMapModal');
    },
  components: {
    Detailmap,
    GroupImageChange,
