<template lang="">
  ...
  <div class="group-detail">
    ...
    <hr />
    <button
      class="new-group cursor-pointer btn btn-outline-secondary"
    ...
    >
      ...
      >
        <path
          d="M8 1a1 1 0 0 1 1 1v5h5a1 1 0 0 1 0 2H9v5a1 1 0 0 1-2 0V9H2a1 1 0 0 1 0-2h5V2a1 1 0 0 1 1-1z"
        />
      </svg>
      <span></span>
    </button>
        ...
        >
          ...
          <div class="btn-group" role="group" aria-label="Theme Map Actions">
            <button
              ...
              @click="goToDetailGroupMap(thememap.id)"
            >
              상세보기
            </button>
            <button
              ...
              @click="editGroupmap(thememap.id)"
            >
              수정
            </button>
            <button
              ...
              @click="deleteGroupmap(thememap.id)"
            >
              삭제
            </button>
          </div>
