...
public class QOurplace extends EntityPathBase<Ourplace> {
    ...
    public final com.kosa.mapbegood.domain.member.entity.QMember memberNickname;
    ...
    public QOurplace(Class<? extends Ourplace> type, PathMetadata metadata, PathInits inits) {
        ...
        this.memberNickname = inits.isInitialized("memberNickname") ? new com.kosa.mapbegood.domain.member.entity.QMember(forProperty("memberNickname")) : null;
    }
